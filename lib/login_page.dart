  ...
  void _handleLogin() async {
    ...
    try {
      ...
      if (user.emailVerified && !isVerifiedInDB) {
        log('Email verification sync: Firebase Auth is verified, but Firestore is not. UPDATING DB...');
      ...
      final Map<String, dynamic>? latestData = docSnapshot.data() as Map<String, dynamic>?;
